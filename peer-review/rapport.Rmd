...
<details>
<summary>Interprétation et réponse</summary>
L'analyse de corrélation de Pearson montre une relation négative faible entre le taux d'inflation et la densité de milliardaires (r=−0,163). Cependant, cette corrélation n'est pas statistiquement significative car p=0,199. L'intervalle de confiance à 95 % de la corrélation inclut zéro [−0,393;0,087]. On ne peut alors,conclure à l'existence d'une relation linéaire entre ces deux variables. Ainsi, le niveau d'inflation observé en 2019 ne semble pas être corrêlé à la densité de milliardaires.
