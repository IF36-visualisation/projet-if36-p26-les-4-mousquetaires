...
```
#Q21 - Quelle est la génération qui regroupe le plus grand nombre de milliardaires ?
```{r stats}

# Chargement des données
billionaires <- read_csv("C:/Users/pret/Downloads/bil-data/Billionaires-Statistics-Dataset.csv")

# Définition des générations selon birthYear
billionaires_gen <- billionaires %>%
